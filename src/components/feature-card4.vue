...
export default {
  ...
  props: {
    description: {
      type: String,
      default:
        'Our website offers a unique feature that allows users to not only book appointments but also make rescheduling and cancellations hassle-free. This flexibility ensures that your schedule is always under your control.',
    },
    title: {
      type: String,
      default: 'Appointment Flexibility',
    },
